...
EXAMPLES = {
    ...
    ("negativ", "frust"): [
        "weiss nöd, wie lang ich das no pack",
        "ich fühl mi grad komplett fertig",
        "cha mi nüm motiviere für öppis",
        "alles isch mir grad z viel, huere scheiss",
        "würd am liebschte alles hinschmeisse",
        "ha s gfühl, ich dreh mi im churzschlus",
        "ha null energie im momänt",
        "ich kämpf und kämpf, aber es bringt nüt",
        "weiss nöd, wo ich ahfange söll",
        "ich fühl mi wie blockiert",
        "es isch alles so schwer grad",
        "bi mega dünnhuutit im momänt",
        "ha s gfühl, alles lauft gegen mi",
        "nüt gelingt mir richtig",
        "ich würd gärn pause mache, aber s gaht nöd",
        "ich ha kei plan meh, wie wiiter",
        "wott eifach chli ruhe ha",
        "fühl mi überrollt vo allem",
        "ich cha nüm so tuen, als wär alles easy",
        "bi voll im kopfchaos",
        "wünscht, ich chönnt endlich abschalte",
        "weiss nöd, wieso ich grad so struggl",
        "ich würd gern positiv bliibe, aber s goht nöd",
        "ich fühl mi mega lost im momänt",
        "jede chliini sache stresst mi übertriebe",
        "ha s gfühl, ich mach nüt richtig",
        "würd so gärn es reset drücke",
        "fühl mi brutal überfodert",
        "ha mini emotionen nüm im griff",
        "bruch dringend chli entlastig",
    ],
    ...
    ("negativ", "stress_alltag"): [
        ...
        "chum kaum no zum durchatme",
        "jedes mol chunnt öppis neus debi",
        "bruch dringend ruhe",
        "bi scho am morgä mega gstresst",
        "ich bin nur am rölle de ganz tag",
        "es schlägt mir langsam uf s gemüt",
        "ha kei puffer meh",
        "ha s gfühl, ich ha kei kontrolle meh",
        "bi immer e schritt z spoot",
        "ha s gfühl, ich lebe nume no im stressmodus",
        "bi nüm fähig, richtig abzuschalte",
        "ich würd gern mal e chli ruhe ha",
        "ha grad vil z vil uf em radar",
        "han kei kopf frei für öppis anders",
        "bi komplett überlastet",
        "weiss nöd, wie ich das tempo lang cha halte",
        "fühl mi nur no erschöpft",
        "bruch dringend entschleunigung",
        "bi am limit vo minere kapazität",
        "würd gern mol e tag ohni to-do-lischte ha",
        "ich kann mich grad uf nüt konzentriere",
        "ha kei erholig zwüschet dur",
        "ich kämpfe täglich mit dem huere stress",
    ],


    ("negativ", "konflikt"): [
        "mir händ scho wieder en riesen streit gha",
        "fuck, ha kei nerv meh für das ständige diskutiere",
        "jedes gspröch eskaliert instant",
        "mir verstöhnd üs gar nüm",
        "alles driftet immer i d falschi richtig",
        "has gfühl, mir reded komplett ane vorbei",
        "weiss nöd, wie mer das löse sött",
        ...
        "fühl mi nöd ernst gno i däm gspröch",
    ...
    ("negativ", "selbstzweifel"): [
        "has gfühl, ich bi nöd guet gnue",
        "ich zweifle grad extrem a mir selber",
        "bi unsicher, öb ich dä challenge würkli packe cha",
        "fühl mi häufig ungenüeg",
        "ha angst, alles falsch z mache",
        "vergliche mi immer mit andere",
        "ich bremse mi selber ständig uus",
        "frag mich, öb ich würkli öppis wert bi",
        "ich fühl mi wie en riesigs fragezeiche",
        "ich bi nöd stolz uf das, was ich mach",
        "glaub, ich enttäusch alli",
        "ha angst, dass ich nüm vorwärts chume",
        "glaub nöd an mini eigete fähigkeit",
        "fühl mi wie en versager",
        "ich weiss nöd, wieso ich so a mir zweifle",
        "jedes chliini problem bringt mi zum grüble",
        "würd gärn meh selbstvertroue ha",
        "has gfühl, ich mach alles nur halb guet",
        "ich weiss nöd, öb ich gut genug bi für dini erwartige",
        "fühl mi oft fehl am platz",
        "ich weiss nöd, wieso ich mir selber so im weg stah",
        "mach mir immer vil zviel druck",
        "ich fühl mi mega verletzlich",
        "weiss nöd, öb ichs verdient ha",
        "ich ha angst vor fehler und drum probier ich nüüt uus",
        "fühl mi extrem unsicher im momänt",
        "würd gern besser zu mir selber sii",
        "has gfühl, ich bi nöd gnue für ander lüt",
        "kämpf viel mit mim innere sauhund",
    ...
    ("negativ", "überforderung_job"): [
        ...
        "scheisse, ha kei ressourcen meh für das",
        "bruch imfall dringend en break",
        "ich has gfühl, ich brenn us",
        "es chunnt immer meh debi und nüt wird weniger",
        "stoss grad a mini grenzen",
        "ich cha nüm klar denke vor lauter stress",
        "mini to-do-lischt macht mi fertig",
        "würd gärn konzentriert schaffe, aber s gaht nöd",
        "ha angst, dass ich s nöd pack",
        "würd am liebschte alles kurz stoppe",
        "bin extrem unter druck",
        "mini arbeit überforderet mi grad brutal",
        "ich bruch unterstützig, aber es chunnt kei",
        "ha immer eng termini, das stresst brutal",
        "cha nüm abschalte nach em schaffe",
        "fühl mi überrollt vo de ufgabe",
        "has gfühl, alli erwarted z vil vo mir",
        "mini motivation isch am sinke",
        "ha angst, dass ich öppis versaue",
        "würd gärn en usglich finde, aber schaffs nöd",
        "glaub, ich bin am absolute limit",
        "ich ha kei kontrolle meh über mini workload",
        "chumm nüm zum pause mache",
        "bi mega erschöpft vo dem jobstress",
        "fuck, weiss nöd, wie lang ich das na ch stemme",
    ],


    ("negativ", "gesundheit_sorge"): [
        "mach mer grad mega sorgä um mini gesundheit",
        "weiss nöd, wieso ich mich ständig komisch fühl",
        "has gfühl, öppis stimmt nöd mit mir",
        "han symptome, wo mi verunsichere",
        "ha angst, dass es öppis ernsthafts isch",
        "ich bin unsicher, öb ich zum arzt söll",
        "bi ständig müed, das macht mi fertig",
        "fühl mi körperlich huere instabil",
        "ha immer wieder unruh im körper",
        "mach mi verrückt mit gedanke",
        "has gfühl, mis imunsystem spinnt",
        "ich weiss nöd, wo d ursach isch",
        "ha angst, dass es schlimmer wird",
        "weiss nöd, wie ich das einschätze söll",
        "fühl mi unwohl und kenn de grund nöd",
        "schlaf schlecht und das stresst mi mega",
        "bi durend erschöpft, das macht mir angscht",
        "ha symptome, wo ich nöd einordne cha",
        "ich fühl mi nöd wie ich selber",
        "ha angst vor dem, was chönnt sii",
        "ha di ganzi zit druck im chopf",
        "mis körpergefühl stimmt nöd",
        "mach mer ständig gedanke über jedi chlinigkeit",
        "ha gärn ruhe, aber d angst bliibt",
        "ha schiss, dass ich öppis überseh",
        "ich weiss nöd, wie lang das no so goht",
        "ich fühl mi körperlich mega angeschlage",
        "ich ha angst, dass es nöd besser wird",
        "spür, dass öppis im unglichgwicht isch",
        "würd gern wüsse, was gnau los isch",
    ],


    ("negativ", "enttäuschung_beziehung"): [
        "ich bi grad richtig enttäuscht vo dere person",
        "ich has gfühl, ich bi nöd priorität für sie",
        "sie händ wieder nüd ernst gnoh, obwohl mer abgmacht händ",
        "mini erwartige sind gar nöd erfüllt worde",
        "ha vil investiert und wenig zrugg übercho",
        "fühl mi i dere beziehig nöd wahrgnuu",
        "weiss nöd, öb mer no am gliiche ort sind",
        "ich has vertroue chli verlore",
        "ich bi traurig über d entwicklung vo dem ganze",
        "has gfühl, ich bedeut nüm so vil wie früener",
        "würd mir meh achtig wünsche, aber es chunt nüd",
        "ich has gfühl, mini bemüehige werde ignoriert",
        "ich weiss nöd, wieso alles so distanziert worde isch",
        "bi verletzt, wie wenig rücksicht gnue wird",
        "ha immer wieder hoffnig, aber sie zerschlägt sich",
        "würd gern es gspröch führe, aber es chunt nie stand",
        "ich fühl mi allei i dere verbindig",
        "weiss nöd, wieso s plötzlich so anders isch",
        "bi enttäuscht, dass kei initiative vo dere site chunnt",
        "has gfühl, mini gefühle werde nöd ernst gno",
        "es het nüd meh vo dem, was s mol gsi isch",
        "han angst, dass es nüm besser wird",
        "has gfühl, ich kämpf allai für die beziehig",
        "bi müed vom ständige probiere",
        "fühl mi ersetzbar und nöd wichtig",
        "weiss nöd, wie lang ich das no cha",
        "bruch eigentlich nächi, aber ich spür distanz",
        "würd gern vertroue, aber es fällt mer schwer",
        "has gfühl, ich bi nur en option und nöd wichtig",
    ...
    ("negativ", "einsamkeit"): [
        ...
        "ich has gfühl, niemer versteht mi würkli",
        "mit wem soll ich drüber rede?",
        "alli händ ihre gruppe, nur ich nöd",
        "würd mir meh nächi wünsche, aber weiss nöd wie",
        "ha vil kontakt online, aber wenig echt nächi",
        "vermisse sgfühl vo ufgnoh sii",
        "fühl mi scho lang isoliert",
        "ich zieh mi immer meh zrugg",
        "ich würd gern näheri verbindige ha",
        "has gfühl, ich bin unsichtbar",
        "fühl mi wie am rand vo allem",
        "ich weiss nöd, wie ich us däm loch usefinde",
        "ich bi oft allei mit mine gedanke",
        "ich würd gern meh soziali momänt ha",
        "has gfühl, ich rede, aber niemer loset",
        "fühl mi de ganze tag einsam, au unter lüte",
        "vermisse richtigi nächi zu öpperem",
        "weiss nöd, wie ich wieder anschluss finde",
        "has gfühl, ich ghör nöd richtig dezue",
        "würd gern es chli wärmi spüre",
        "fühl mi eifach leer und allei",
        "has gfühl, ich bin d ganz zit am warten uf öpper",
        "würd gern meh menschliche kontakt ha",
        "fühl mi manchmal wie verdrängt",
        "weiss nöd, öb öpper würkli für mich do wär",
        "fühl mi wie abgeschnitten vo allne",
        "ha mega angst, dass ich für immer so allei blibe",
        "wött eifach wieder verbindig spüre",
    ],
    ...
    ("positiv", "dank"): [
        ...
        "ich bi dir würkli huere dankbar für dini hilf",
        ...
        "ich bin huere froh um dis feedback, merci",
        ...
        "danke für dine coole input, isch mega wertvoll gsi",
        "merci, dass du mir immer wieder hilfsch",
        "bi dir sehr dankbar für dini meinig",
        ...
        "merci, du hesch mir würklich druck usegnah",
    ],
    ...
    ("positiv", "lob"): [
        ...
        "du hesch dä task richtig guet gmastered",
        ...
        "ich finds toll, wie kreativ du bisch",
        "dinu idee isch mega clever gsi",
        "ich bi positiv überrascht vo dim ansatz",
        "du hesch s thema huere guet begriffe",
        "ich finds mega stark, wie du das glöst hesch",
    ...
    ("positiv", "freud"): [
        ...
        "chans chum glaube, wie guet das cho isch",
        "bin richtig begeischtert",
        "ich ha so freud gha, das z'erlebe",
        "das git mir grad mega viel energie",
        "ha so en schöne moment gha",
        "bi mega happy grad",
        "freu mi so fescht, dass das klappt het",
        "es isch eifach schön gsi",
        "ich chan grad richtig ufpüschelet atme",
        "bi so zufrieden mit dem ganze",
        "has so chli im herz gspürt, vor freud",
        "ich finds wunderschön, wies cho isch",
        "ich bi mega erliechtert und froh",
        "ich han richtig freud ghaa, das z teile",
        "bin so glücklich über dä verlauf",
        "freu mi jedes mol wieder drüber",
        "ich ha das mega genosse",
        "das het mi würkli stärkt",
        "bin voller freud i dä situation",
        "han echt chli gwunder, wie guet s cho isch",
        "bi mega positiv überrascht worde",
    ...
    ("positiv", "erfolg"): [
        ...
        "ha im job en schöne erfolg gha",
        "spür grad richtig fortschritt",
        "bi mega zfriede mit mim outcome",
        "es isch besser cho als erwartet",
        "ha dä milestone endlich erreicht",
        "has gfühl, ich wachse grad richtig a dere ufgab",
        "ich ha öppis gschafft, wo ich nöd sicher gsi bi",
        "ha feedback übercho, dass es top gsi isch",
        "bi stolz uf mini performance",
        "ich ha öppis erreicht, wo mir vil bedeutet",
        "bi mega froh über dä erfolg",
        "chan eifach stolz sii uf mich",
        "ich ha öppis gschafft, wo lang angestanden isch",
        "ich würds am liebste allem verzelle",
        "es isch schön, öppis abghäkelt z ha",
        "bi imfall grad im flow",
        "ich ha richtig en step forward gmacht",
        "ich bi so erlichteret, dass s klappt het",
        "a öppis usprobiert und es het funktioniert",
    ...
    ("positiv", "erleichterung"): [
        "ich bi so froh, dass das jetzt um isch",
        "mir isch en riesen stei vom härz gfalle",
        "ha lang sorgä gha und jetzt isch s doch guet cho",
        ...
        "ich bi so happy, dass es funktioniert het",
        "es tuet mega guet, dass s jetzt klar isch",
        "ha lang gwartet und jetzt isch es endlich vom tisch",
        "bin froh, dass ich nöd ganz falsch glege bi",
        "ha lang drüber nachdacht und jetzt passt s für mich",
        "bi froh, dass ich die entscheidig endlich ha",
        "ich bi erliechtert, dass ich es nöd verschlimmert ha",
        "chan wieder normal schlofe, so erleichtert bi ich",
        "han freud, dass ich das hinder mir ha",
        "has gfühl, mini lascht isch chli lichter worde",
        "bi erliechtert, wie guet s am end usecho isch",
        "ich bi froh, dass ich nöd alles falsch verstande ha",
        "ich chan wieder es bisschen entspanne",
        "mega, dass alles so friedlich blibe isch",
        "bi mega froh, dass s nöd eskaliert isch",
        "endlich cha ich druck us em chopf loh",
        "ich has gfühl, ich ha wieder boden unter de füss",
        "findi schön, dass ich nöd alei bin",
        "bi froh, dass sich die sorgä nöd bestätigt händ",
        "bi mega happy, dass ich d'lösig gfunde ha",
        "bi froh, dass ich das theama endlich abghäklet han",
        "ich has gfühl, ich chan wieder dureschnufe",
        "ich bi mega happy über dä ausgang",
    ],


    ("positiv", "stolz"): [
        "ich bi würkli mega stolz uf mich grad",
        "ha öppis gstemt, wo ich mir nöd zuegtraut ha",
        "es isch schön z gseh, wie wiit ich cho bi",
        "ich ha s gfühl, ich cha zurecht stolz sii",
        "ha hart derfür gschaffet und shet sich glohnt",
        "bi zfriede mit mir und minere performance",
        "bi stolz, dass ich drablube bi",
        "han mini eigete erwartige übertroffe",
        "cha uf das resultat mit stolz luege",
        "stolz, wie ich mit dä situation umgange bi",
        "bi huere stolz, dass ich mini werte bewahrt ha",
        "ich ha mini komfortzone verliä und es het sich glohnt",
        "ich bi stolz uf jedes chliini schrittli",
        "finds coll, dass ich dr schnauf ha do z'bliibe",
        "ich bi vo mir selber beidruckt, wie ich das packt ha",
        "ich bi stolz, dass ich mich nöd unterkriege lah ha",
        "cha ehrlich säge, dass ich stolz uf mich bi",
        "bi stolz, dass ich s durchzieh ha",
        "stolz uf mini entwicklung",
        "cha mini erfolg würkli spüre",
        "ich bi stolz, dass ich so vill gelernt ha",
        "bin stolz, dass ich Verantwortung übernoh ha",
        "cool, dass ich mini gränze akzeptiere cha",
        "hand freud, wie ich aus fehler glärnt ha",
        "ich bi stolz uf mini disziplin",
        "fühle chli stolz, wie ich das gemeistert ha",
        "ha endlich s gfühl, ich cha öppis",
        "finds cool, dass ich mi nöd ha stressä lah",
        "bitz stolz, dass ich mini ziele verfolge",
        "ich bi stolz uf mini schritt i d richtige richtig",
    ],


    ("positiv", "verbindung_freunde"): [
        "mir händ en mega gmüetliche abig gha",
        "ich bi so froh um dini fründschaftä",
        "mir händ so viel glacht, das het guet ta",
        "fühl mi grad richtig ufgnoh i dere gruppe",
        "ich ha s gfühl, mir verstöhnd üs immer besser",
        "mir händ sogar über ernsti sache chönne rede",
        "schätz es uh mega, so mensche um mich z ha",
        "ha lang nüm so es ehrlechs gspröch gha",
        "bin dankbar für die nöchi, wo mir händ",
        ...
        "han mich richtig wohl gfühlt bi üse abmachig",
        "has gfühl, mini fründe gäh mir mega viel halt",
        "bi dankbar für jede minute wo mer zäme verbringened",
        "ich ha fründ, wo ehrlich zu mir sind – das isch gold wert",
        "finds schön, dass mir so offe chönd rede",
        "mini fründe gäh mir richtig viel energie",
        "ich ha wieder mol gmärkt, wie wichtig fründe sind",
        "bi mega froh, so lüt i mim läbe z ha",
        "ich fühl mi unterstützt und nöd alei",
        "mir händ so en schöne vibe zäme",
        "has wunderschön gfunde, üses treffe",
        "mini fründe sind würkli wertvoll für mi",
        "bi richtig dankbar für üs allne",
        "ich ha s gfühl, mini fründschaftä wärded immer tiefer",
        "ha en mega schöne momänt mit dir erlebt",
        "es isch so guet, sich verstanden z fühle",
    ],


    ("positiv", "motivation"): [
        "bi imfall voll motiviert grad",
        "ha richtig bock, öppis azpacke",
        "ich bi voller energie im momänt",
        "has gfühl, jetzt isch en guete moment für neues",
        "ha so vill idee, die ich umsetze wott",
        "spür grad richtig drive i mir",
        "ich bi mega parat für die nächschte schritt",
        "ha sogar freud am challenge",
        "ich fühl mi richtig produktiv",
        "has gfühl, ich cha grad mega vill bewege",
        "ich bin motiviert wie scho lang nüm",
        "schmöck grad e chli erfolgsluft",
        "ich bi voll im fokus",
        "ha mega bock zum dranzbliibe",
        "glaub, ich cha richtig gueti ideä umsetze",
        "bi voll im flow grad",
        "würd am liebschte grad starte",
        "spür mega viel kraft im momänt",
        "ich bin motiviert, öppis neu z probiere",
        "has gfühl, alles isch möglich grad",
        "ha voll lust uf s projekt",
        "bi mega driven",
        "glaub, es chunt öppis guets use",
        "bin richtig wach und parat",
        "ich ha richtig en schub übercho",
        "ich bi mega inspiriert",
        "ich ha viel energie für die ufgabe",
        "ich bi voller elan",
        "spür en positivie vibes",
